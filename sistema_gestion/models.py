...
class tabla_amortizacion(models.Model):
    ...
    pago_interes = models.FloatField(default=0)
    pago_capital = models.FloatField(default=0)
    balance_total_esperado = models.FloatField()
    balance_interes_esperado = models.FloatField()
    balance_capital_esperado = models.FloatField()

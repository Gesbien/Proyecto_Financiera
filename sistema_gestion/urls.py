...
urlpatterns = [
    ...
    path('cliente/vista/<cedula>', personas.vista_cliente, name='inicio_cliente'),
    path('cliente/reporte', personas.generar_reporte.as_view(), name='inicio_cliente'),
    ...
    path('cobros/registrar/<id_prestamo>/<fecha>', cobros.crear_cobro, name='registrar_cobro'),
    path('cobros/registrar/actualizar/', cobros.actualizar_datos, name='actualizar_datos'),
    path('cobros/registrar/sumatoria/', cobros.sumatoria_datos, name='sumar_datos'),
